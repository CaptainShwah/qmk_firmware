...
zeal_backlight_config g_config = {
	...
	.effect_speed = 3,
	.color_1 = { .h = 85, .s = 0, .v = 255 },
	.color_2 = { .h = 0, .s = 255, .v = 255 },
	.caps_lock_indicator = { .color = { .h = 0, .s = 0, .v = 100 }, .index = 255 },
	.layer_1_indicator = { .color = { .h = 0, .s = 0, .v = 100 }, .index = 255 },
	.layer_2_indicator = { .color = { .h = 0, .s = 0, .v = 100 }, .index = 255 },
	.layer_3_indicator = { .color = { .h = 0, .s = 0, .v = 100 }, .index = 255 },
	.alphas_mods = {
